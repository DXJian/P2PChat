...
<body>
    <div class="container">
        <div class="error">
            <h1>503</h1>
            <h2>error</h2>
            <p>Oops, you caught us doing a secret experiment! Don't worry we will be back in few seconds!</p>
            <button type="button" onclick="location.reload()" class="btn">Check again!</button>
        </div>
